...
[GameLocale](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Localization.Enumeration.GameLocale)
names the languages the game itself ships, and
[GameLocales](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Localization.Class.GameLocales)
