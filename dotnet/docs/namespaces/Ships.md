...
[ShipCatalogue](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Ships.Class.ShipCatalogue)
for hulls,
[ModuleCatalogue](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Ships.Class.ModuleCatalogue)
for outfitting, and
[BlueprintCatalogue](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Ships.Class.BlueprintCatalogue)
with
[ExperimentalEffectCatalogue](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Ships.Class.ExperimentalEffectCatalogue)
for engineering.
[Slef](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Ships.Class.Slef)
...
[failure model](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/wiki/DotNet.Document.The-failure-model)
