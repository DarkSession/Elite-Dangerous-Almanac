 ...
 * run-length geometry in [`data/astro/galactic-region-cells.jsonc`](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/blob/main/data/astro/galactic-region-cells.jsonc) (kept separate
 ...
 * See [ATTRIBUTIONS.md](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/blob/main/ATTRIBUTIONS.md) for credit and licence terms.
 *
