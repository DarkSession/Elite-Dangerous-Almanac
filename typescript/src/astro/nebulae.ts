 ...
 * 30 KB. `ALL_NEBULAE` is 682 KB (151 KB gzipped) — 94% of it planetary nebulae most
 * apps never touch — so defaulting to it would quietly cost more than the rest of
 * the library put together. Name the catalogue you want here.
 *
 * @example
 * ```ts
