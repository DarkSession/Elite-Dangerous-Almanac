 ...
 * @throws {RangeError} If the mass code is outside 0–7, a letter is outside 0–25, the
 * origin has a negative coordinate, the name's boxel code or sector falls outside the
