 ...
 * [`data/astro/SOURCES.md`](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/blob/main/data/astro/SOURCES.md) for provenance and source terms.
 *
 ...
 * wins. Data is loaded once from shared JSON ([`data/astro/`](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/tree/main/data/astro)).
 *
 * @remarks
