 ...
 *
 * Data from EDCD FDevIDs (`microresources.csv`), in-game verification and Inara; see [`data/materials/SOURCES.md`](https://github.com/Elite-Dangerous-Almanac/Almanac-Core/blob/main/data/materials/SOURCES.md).
 *
...
/**
 * Every data micro resource, in catalogue order.
 *
 * @remarks
 ...
 *
 * DATA_MICRO_RESOURCES.find((resource) => resource.symbol === 'nocdata')?.name; // -> 'NOC Data'
 * ```
 */
