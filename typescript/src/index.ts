 ...
 *
 * The root entry point re-exports each feature area's general API. Large catalogues
 * stay on explicit subpaths, and all symbols are available from their individual
